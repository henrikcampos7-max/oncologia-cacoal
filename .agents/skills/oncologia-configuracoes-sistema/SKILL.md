---
name: oncologia-configuracoes-sistema
description: Implementar e revisar configurações da Oncologia Cacoal. Usar em clínica, preferências, alertas, segurança, backup, exportação e regras operacionais.
---
...
- Usar `docs/referencias-visuais/12.png` como referência visual, sem transformar a imagem na interface.
- Preservar dados fictícios, menor privilégio, auditoria e revisão humana.
- Consultar como lentes especializadas: perfis-acesso, seguranca-lgpd, devops-implantacao, notificacoes, frontend-ux e qa-oncologia.

## Fluxo

1. Confirmar as funções do módulo: preferências, alertas, segurança, backup, exportação e regras operacionais.
