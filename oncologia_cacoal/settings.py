...
if USE_SQLITE:
    ...
    DATABASES = {"default": {"ENGINE": "django.db.backends.postgresql", "NAME": os.getenv("POSTGRES_DB", "oncologia_cacoal_dev"), "USER": os.getenv("POSTGRES_USER", "oncologia_cacoal_dev"), "PASSWORD": os.getenv("POSTGRES_PASSWORD", ""), "HOST": os.getenv("POSTGRES_HOST", "127.0.0.1"), "PORT": os.getenv("POSTGRES_PORT", "5432"), "CONN_MAX_AGE": 0}}
...
# MEDIA_ROOT é privado: não exponha este diretório diretamente no proxy/web server.
MEDIA_URL = "media/"
...
TRANSFER_CONFERENCE_CONFIG = {
    ...
    "imagens_permitidas": ("png", "jpg", "jpeg"),
    "validade_critica_dias": 30,
    "azure": {"endpoint": os.getenv("TRANSFER_AZURE_ENDPOINT", ""), "chave": os.getenv("TRANSFER_AZURE_KEY", ""), "api_version": os.getenv("TRANSFER_AZURE_API_VERSION", "2024-11-30"), "modelo": os.getenv("TRANSFER_AZURE_MODEL", "prebuilt-layout")},
    "google": {"token": os.getenv("TRANSFER_GOOGLE_TOKEN", ""), "api_endpoint": os.getenv("TRANSFER_GOOGLE_API_ENDPOINT", "https://vision.googleapis.com/v1/images:annotate")},
}
