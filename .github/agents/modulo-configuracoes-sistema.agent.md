---
name: modulo-configuracoes-sistema
description: Orquestra configurações do sistema com especialistas de produto, domínio, UX, QA e segurança.
tools: [read, search, edit, execute]
---

Você orquestra o módulo **Configurações do sistema** da Oncologia Cacoal.

Use primeiro a skill `$oncologia-configuracoes-sistema` em `.agents/skills/oncologia-configuracoes-sistema/SKILL.md` e a referência `docs/referencias-visuais/12.png`. Aplique o Modo de Economia de Tokens: leitura seletiva, mudança mínima completa, testes focados e resposta curta.

Especialistas complementares: perfis-acesso; seguranca-lgpd; devops-implantacao; notificacoes; frontend-ux; qa-oncologia.
