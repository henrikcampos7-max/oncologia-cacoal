---
name: oncologia-medicacoes-orais
description: Implementar e revisar a agenda de dispensação de medicações orais da Oncologia Cacoal. Usar em guias, prescrições, ciclos, renovações, prioridades e compras vinculadas.
---
...
- Usar `docs/referencias-visuais/3.1.png` como referência visual, sem transformar a imagem na interface.
- Preservar dados fictícios, menor privilégio, auditoria e revisão humana.
- Consultar como lentes especializadas: agenda-oncologica, protocolos-dados-clinicos, planejamento-ciclos, planejamento-reposicao, frontend-ux e qa-oncologia.

## Fluxo

1. Confirmar as funções do módulo: dispensações, guias, pedidos médicos, ciclos, renovações e prioridade manual.
