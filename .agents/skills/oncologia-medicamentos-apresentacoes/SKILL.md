---
name: oncologia-medicamentos-apresentacoes
description: Implementar e revisar medicamentos e apresentações da Oncologia Cacoal. Usar em cadastro, concentração, unidade, frascos, estoque mínimo, ativação, edição e qualidade cadastral.
---
...
- Usar `docs/referencias-visuais/4.png` como referência visual, sem transformar a imagem na interface.
- Preservar dados fictícios, menor privilégio, auditoria e revisão humana.
- Consultar como lentes especializadas: doses-apresentacoes, banco-dados, estoque-compras, protocolos-dados-clinicos, frontend-ux e qa-oncologia.

## Fluxo

1. Confirmar as funções do módulo: medicamento, apresentação, concentração, unidade, mínimo, status e revisão.
